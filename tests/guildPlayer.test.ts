...
jest.mock('../src/utils/createShuffleStack', () => jest.fn(() => ['track2', 'track1', 'track3']));
...
describe('GuildPlayer', () => {
  ...
  test('Skip method when stack is empty and rand is true', () => {
    ...
    expect(spyPlay).toHaveBeenCalledWith(path.join(process.env.PLAYLISTS_FOLDER!, guild_id, 'track2.mp3'));2
  });
